...
响应变量服从泊松分布 BYM-INLA [@blangiardo2013] BYM-Stan [@morris2019; @donegan2022; @cabral2022]

记录 1975-1986 年苏格兰 56 个地区的唇癌病例数 [@moraga2020]，这是一个按地区汇总的数据。
