...
``` bash
# 拉取镜像
docker pull ghcr.io/xiangyunhuang/fedora-rstudio-pro:1.4.455
# 进入项目目录
cd ~/Documents/data-analysis-in-action
# 启动容器
docker run -itd -p 8484:8787 --name=daar \
  --privileged=true -v "/${PWD}:/home/docker" \
  ghcr.io/xiangyunhuang/fedora-rstudio-pro:1.4.455
# 进入容器
...
Package version:
  abess_0.4.8               abind_1.4.5               arrow_13.0.0.1           
  AsioHeaders_1.22.1.2      askpass_1.2.0             assertthat_0.2.1         
  backports_1.4.1           base_4.3.1                base64enc_0.1.3          
  bayesplot_1.10.0          BB_2019.10.1              beanplot_1.3.1           
  beeswarm_0.4.0            BH_1.81.0.1               bigD_0.2.0               
  bit_4.0.5                 bit64_4.0.5               bitops_1.0.7             
  blme_1.0.5                blob_1.2.4                boot_1.3.28.1            
  bridgesampling_1.1.2      brio_1.1.3                brms_2.20.4              
  Brobdingnag_1.2.9         broom_1.0.5               broom.helpers_1.14.0     
  bslib_0.5.1               cachem_1.0.8              callr_3.7.3              
  car_3.1.2                 carData_3.0.5             checkmate_2.3.0          
  chromote_0.1.2            class_7.3.22              classInt_0.4.10          
  cli_3.6.1                 clipr_0.8.0               cluster_2.1.4            
  cmdstanr_0.6.1            coda_0.19.4               codetools_0.2.19         
  ...
  crayon_1.5.2              crosstalk_1.2.0           curl_5.1.0               
  data.table_1.14.8         datasauRus_0.1.6          datasets_4.3.1           
  DBI_1.1.3                 dbplyr_2.4.0              deldir_1.0.9             
  desc_1.4.2                dichromat_2.0.0.1         diffobj_0.3.5            
  digest_0.6.33             distributional_0.3.2      docopt_0.7.1             
  dotCall64_1.0.2           downlit_0.4.3             dplyr_1.1.3              
  ...
  ggbump_0.1.99999          ggdensity_1.0.0           ggeffects_1.3.2          
  ggExtra_0.10.1            ggfittext_0.10.1          ggforce_0.4.1            
  ggfortify_0.4.16          ggmosaic_0.3.3            ggnewscale_0.4.9         
  ggplot2_3.4.4             ggpubr_0.6.0              ggraph_2.1.0             
  ggrepel_0.9.4             ggridges_0.5.4            ggsci_3.0.0              
  ggsignif_0.6.4            ggstats_0.5.0             ggTimeSeries_1.0.2       
  ...
  hms_1.1.3                 htmlTable_2.4.2           htmltools_0.5.6.1        
  ...
  lifecycle_1.0.3           linprog_0.9.4             listenv_0.9.0            
  littler_0.3.18            lme4_1.1.34               lmtest_0.9.40            
  loo_2.6.0                 lpSolve_5.6.19            lvplot_0.2.1             
  magic_1.6.1               magick_2.8.1              magrittr_2.0.3           
  mapproj_1.2.11            maps_3.4.1                markdown_1.11            
  MASS_7.3.60               Matrix_1.6.1.1            MatrixModels_0.5.2       
  matrixStats_1.0.0         mclogit_0.9.6             memisc_0.99.31.6         
  memoise_2.0.1             methods_4.3.1             mgcv_1.9.0               
  mime_0.12                 miniUI_0.1.1.1            minqa_1.2.6              
  misc3d_0.9.1              mnormt_2.1.1              modeltools_0.2.23        
  multcomp_1.4.25           munsell_0.5.0             mvtnorm_1.2.3            
  ncvreg_3.14.1             nleqslv_3.3.4             nlme_3.1.163             
  nloptr_2.0.3              nnet_7.3.19               numDeriv_2016.8.1.1      
  openssl_2.1.1             ordinal_2022.11.16        packrat_0.9.2            
  pals_1.8                  parallel_4.3.1            parallelly_1.36.0        
  ...
  polyclip_1.10.6           polynom_1.4.1             posterior_1.4.1          
  praise_1.0.0              prettyunits_1.2.0         pROC_1.18.4              
  processx_3.8.2            productplots_0.1.1        progress_1.2.2           
  projpred_2.7.0            promises_1.2.1            proxy_0.4.27             
  ps_1.7.5                  purrr_1.0.2               pwr_1.3.0                
  qpdf_1.3.2                quadprog_1.5.8            quantmod_0.4.25          
  quantreg_5.97             quarto_1.3                QuickJSR_1.0.7           
  R6_2.5.1                  ragg_1.2.6                randomForest_4.7.1.1     
  rappdirs_0.3.3            RColorBrewer_1.1.3        Rcpp_1.0.11              
  RcppArmadillo_0.12.6.4.0  RcppEigen_0.3.3.9.3       RcppParallel_5.1.7       
  ...
  rjags_4.14                rlang_1.1.1               rmarkdown_2.25           
  ...
  rprojroot_2.0.3           rsconnect_1.1.1           RSQLite_2.3.2            
  ...
  sourcetools_0.1.7.1       sp_2.1.1                  spacetime_1.3.0          
  spam_2.10.0               spaMM_4.4.0               sparseinv_0.1.3          
  SparseM_1.81              spatial_7.3.16            spData_2.3.0             
  spdep_1.2.8               splancs_2.1.44            splines_4.3.1            
  StanHeaders_2.32.2        stars_0.6.4               statmod_1.5.0            
  ...
  TMB_1.9.6                 tools_4.3.1               treemapify_2.5.6         
  ...
  viridis_0.6.4             viridisLite_0.4.2         vroom_1.6.4              
  waldo_0.5.1               webshot2_0.1.1            websocket_1.4.1          
  withr_2.5.1               wk_0.9.0                  xfun_0.40                
  xgboost_1.7.5.1           xml2_1.3.5                xtable_1.8.4             
