...
# mar 内边空
# oma 外边空
op <- par(mar = c(4, 4, 3, 4), oma = c(0, 0, 0, 2))
plot(
  Sepal.Length ~ Sepal.Width,
  data = iris, col = Species, pch = 16,
  main = "Edgar Anderson's Iris Data"
)
points(x = 4.5, y = 7, pch = 16, cex = 1, col = "#EA4335", xpd = T)
text(x = 4.5, y = 7, labels = "setosa", pos = 4, col = "#EA4335", xpd = T)
mtext(text = "setosa", side = 4, line = -2, outer = T)
mtext(text = "versicolor", side = 4, line = -1, outer = T)
