...
鸢尾花是非常漂亮的一种花，在统计和机器学习社区家喻户晓，更别提在植物界的名声。其实，远不止于此，在绘画艺术界也是如雷贯耳，意大利印象派大师梵高画了一系列鸢尾花作品。下面先让我们一睹芳容。

::: {#fig-iris layout-ncol="3"}
![setosa 山鸢尾](images/iris-setosa.jpeg){#fig-iris-setosa}

![versicolor 杂色鸢尾](images/iris-versicolor.jpeg){#fig-iris-versicolor}

![virginica 弗吉尼亚鸢尾](images/iris-virginica.jpeg){#fig-iris-virginica}
