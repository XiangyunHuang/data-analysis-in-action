...
### ggplot2 和 Base R 对比 {#sec-ggplot2-vs-base-r}
...
usa_mortality <- readRDS(file = "data/usa-mortality.rds")
library(patchwork)
...
gapminder <- readRDS(file = "data/gapminder.rds")
...
ggplot(data = gapminder_2007, aes(x = gdpPercap, y = lifeExp)) +
  ...
  geom_text_repel(
    data = gapminder_2007[gapminder_2007$pop >= 5 * 10^7, ],
...
ggplot(data = gapminder_2007, aes(x = gdpPercap, y = lifeExp)) +
  ...
  theme(
    ...
    strip.text = element_text(family = "Noto Serif CJK SC"),
...
p1 <- ggplot(data = gapminder[gapminder$year == 2020, ], 
...
p2 <- ggplot(data = gapminder[gapminder$year == 2010, ], 
             aes(x = gdpPercap, y = lifeExp)) +
  geom_point(aes(color = income_level, size = pop)) +
  scale_color_brewer(palette = "RdYlGn") +
  scale_radius(range = c(1, 6), trans = "log10",
...
p3 <- ggplot(data = gapminder[gapminder$year == 2000, ], 
             aes(x = gdpPercap, y = lifeExp)) +
  geom_point(aes(color = income_level, size = pop)) +
  scale_color_brewer(palette = "RdYlGn") +
  scale_radius(range = c(1, 6), trans = "log10",
