...
此时，可以在模型中添加空间效应 $S(x_i)$ ，下面拟合带空间效应的广义线性混合效应模型：
...
从输出结果来看，自协方差函数中参数 $\rho = \sqrt{2 \times 0.2587} / 3.154 \times 10^4 = 2280.613$，$\nu = 0.2587$。随着距离增加，相关性递减，近邻相关性辐射最远为 2280.613 米。
