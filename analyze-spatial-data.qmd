...
将预测结果以散点图的形式呈现到图上，考虑到核辐射在全岛的分布应当是连续性的，空间连续性也是这类模型的假设，接下来要绘制热力图。为了绘制热力图，利用 **stars** 包[@stars2022]将预测数据按原网格化的精度转化成栅格对象，裁减超出朗格拉普岛海岸线以外的内容。
...
```{r}
#| label: fig-rongelap-pred-sp-stars
#| fig-cap: "朗格拉普岛核辐射强度的分布"
#| fig-width: 7
#| fig-height: 4.5
#| fig-showtext: true
