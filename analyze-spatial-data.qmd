...
下 @fig-gambia-map 是用 **ggplot2** 包和**tidyterra**包绘制的，[**tidyterra**](https://github.com/dieghernan/tidyterra) 包基于 [**terra**](https://github.com/rspatial/terra) 包提供一些专门用于栅格数据可视化的图层，扩展了 **ggplot2** 包的功能。国家基础设施建设落后，医疗卫生条件比较差，越靠近河流的地方，水草越多，蚊虫也越多，疟疾容易通过蚊虫叮咬感染和传播。如 @fig-gambia-map 所示，冈比亚国家整体上海拔比较低，最高的地方不超过 100 米，沿着冈比亚河，各个村庄分布在南、北岸。
