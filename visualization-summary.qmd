...
1.  **graphics** 包提供函数 `persp()` 绘制三维透视图，基于 **graphics** 包， [**scatterplot3d**](https://cran.r-project.org/package=scatterplot3d) 包[@scatterplot3d] 主要绘制三维散点图，而 [**plot3D**](https://cran.r-project.org/package=plot3D) 包[@plot3D2021] 提供更加丰富的三维图形，曲面图、柱状图、分片图等。
