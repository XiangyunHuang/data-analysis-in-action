...
dat <- tribble(
  ...
  "描述趋势", "透视图", "persp", "wireframe", "",
  "描述趋势", "条件图", "coplot", "", "",
  "描述趋势", "条件图", "lines", "panel.lines", "geom_line",
  ...
  "描述分布", "一维散点图", "stripchart", "stripplot", "",
  "描述分布", "茎叶图", "stem", "", "",
...
::: {.callout-tip}
三个作图工具的使用方法截然不同，以条件密度图为例，Base R 的绘制函数为 `cdplot()`，而 **ggplot2** 包提供图层函数 `geom_density()`，等价的示例如下：
