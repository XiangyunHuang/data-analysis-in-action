...
ggplot() +
  geom_function(fun = dbeta, args = list(shape1 = 3, shape2 = 0.9), 
                col = "#E41A1C", linewidth = 1.2) +
  geom_function(fun = dbeta, args = list(shape1 = 3, shape2 = 9), 
                col = "#377EB8", linewidth = 1.2) +
  theme_classic() +
  labs(x = expression(x), y = expression(Gamma(x)))
```
