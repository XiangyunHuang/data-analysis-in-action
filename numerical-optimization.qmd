...
目标函数是线性的，目标变量的取值要么是 0 要么是 1。指派问题属于典型的 0-1 整数规划问题。有 $n$ 个人需要去完成 $n$ 项任务，每个人完成一项任务，每项任务只由一个人完成，每个人单独完成各项任务所需花费（时间、费用）不同。要求设计一个方案，人和任务之间建立一一对应的关系，使得总花费最少。
...
在二次规划的基础上，对变量添加整型约束，即变成混合整数二次规划 （Mixed Integer Quadratic Programming，简称 MIQP）。
...
目前，**ROI** 包支持的开源求解器都不能处理 MIQP 问题。**ECOSolveR** 包可以求解一些锥规划，部分变量可以是整数。先可将凸二次规划转为凸锥规划问题，连接 **ECOSolveR** 包提供 `ecos` 求解器，再调 `ecos` 求解器求解。
...
因二次规划的目标函数是二次连续可微的，而且是凸函数，求解器 Bonmin 可以获得最优解。
...
NLP0014I             1         OPT -0.083333363        5 0.006141
NLP0012I 
              Num      Status      Obj             It       time                 Location
NLP0014I             1         OPT -4.9979999e-08        5 0.005499
NLP0014I             2         OPT -3.999e-08        5 0.00661
NLP0012I 
              Num      Status      Obj             It       time                 Location
NLP0014I             1         OPT -3.999e-08        5 0.007364
Cbc0012I Integer solution of -3.999e-08 found by DiveMIPFractional after 0 iterations and 0 nodes (0.02 seconds)
NLP0014I             2         OPT -4.9979999e-08        5 0.007163
NLP0014I             3         OPT 1.75        6 0.008877
Cbc0001I Search completed - best objective -3.998999975607376e-08, took 0 iterations and 0 nodes (0.04 seconds)
...
在 R 语言社区的官方仓库中还没有开源的 R 包可以求解此类问题，开源社区中 [Bonmin](https://github.com/coin-or/Bonmin/) 项目专门求解混合整数非线性优化 MINLP（Mixed Integer NonLinear Programming）问题。数学规划软件 AMPL 封装了 Bonmin 软件，并提供 R 语言接口 [rAMPL](https://github.com/ampl/rAMPL)。AMPL [社区版](https://ampl.com/ce/)可以免费使用打包的开源求解器。

-   线性规划求解器 [HiGHS](https://github.com/ERGO-Code/HiGHS)。
...
NLP0012I 
              Num      Status      Obj             It       time                 Location
NLP0014I             1         OPT -4.20616        6 0.007111
NLP0014I             2         OPT -4.1760121        4 0.004135
NLP0014I             3         OPT -3.7431994        5 0.004932
Cbc0010I After 0 nodes, 1 on tree, 1e+50 best solution, best possible -1.7976931e+308 (0.01 seconds)
NLP0014I             4         OPT -4.1760121        4 0.004646
NLP0012I 
              Num      Status      Obj             It       time                 Location
NLP0014I             1         OPT -4.1760121        8 0.006857
Cbc0004I Integer solution of -4.1760121 found after 4 iterations and 1 nodes (0.03 seconds)
NLP0014I             5         OPT -3.7431994        5 0.005481
Cbc0001I Search completed - best objective -4.176012057187287, took 9 iterations and 2 nodes (0.03 seconds)
Cbc0032I Strong branching done 1 times (9 iterations), fathomed 0 nodes and fixed 0 variables
Cbc0035I Maximum depth 0, 0 variables fixed on reduced cost
    "Finished"
...
Bonmin 求解器的结果显示在 $(2.892556, 1.702552, -1)$ 处获得最优解，目标函数值为 $-4.176012$ ，实际上，这是一个局部最优解。下面调用另一个求解器 Couenne 求解该问题，实际上，Couenne 好于 Bonmin 求解器，它可以找到非凸混合整数非线性规划问题的全局最优解。
...
couenne: 
ANALYSIS TEST: Couenne: new cutoff value 0.0000000000e+00 (0.020553 seconds)
NLP0012I 
              Num      Status      Obj             It       time                 Location
NLP0014I             1         OPT -4.20616        6 0.007888
Couenne: new cutoff value -3.5706477181e+00 (0.030724 seconds)
NLP0014I             2         OPT -3.7431994        5 0.0058
Couenne: new cutoff value -3.7431993642e+00 (0.037854 seconds)
Loaded instance "/var/folders/cv/7n2v46gx65bbdtv7ctx7jtmh0000gn/T/at87353.nl"
Constraints:            0
Variables:              3 (1 integer)
Auxiliaries:            9 (1 integer)

Coin0506I Presolve 25 (0) rows, 12 (0) columns and 65 (0) elements
Clp0006I 0  Obj -640 Primal inf 971.14086 (10)
Clp0006I 11  Obj -610
Clp0000I Optimal - objective value -610
Clp0032I Optimal objective -610 - 11 iterations time 0.002
Clp0000I Optimal - objective value -610
Cbc0012I Integer solution of -3.7431994 found by Couenne Rounding NLP after 0 iterations and 0 nodes (0.00 seconds)
NLP Heuristic: NLP0014I             3         OPT -3.1414994        6 0.008408
no solution.
Clp0000I Optimal - objective value -610
Optimality Based BT: 7 improved bounds
Probing: 2 improved bounds
NLP Heuristic: time limit reached.
Cbc0031I 6 added rows had average density of 2.3333333
Cbc0013I At root node, 6 cuts changed objective from -610 to -340.9018 in 10 passes
Cbc0014I Cut generator 0 (Couenne convexifier cuts) - 27 row cuts average 2.1 elements, 2 column cuts (2 active)
Cbc0010I After 0 nodes, 1 on tree, -3.7431994 best solution, best possible -340.9018 (0.03 seconds)
Optimality Based BT: 7 improved bounds
Couenne: new cutoff value -4.1760120572e+00 (0.084431 seconds)
Cbc0012I Integer solution of -4.1760121 found by Couenne Rounding NLP after 38 iterations and 1 nodes (0.05 seconds)
Optimality Based BT: 7 improved bounds
Optimality Based BT: 5 improved bounds
Optimality Based BT: 6 improved bounds
Optimality Based BT: 6 improved bounds
Optimality Based BT: 8 improved bounds
Couenne: new cutoff value -9.9782461145e+00 (0.279699 seconds)
Cbc0012I Integer solution of -9.9782461 found by Couenne Rounding NLP after 254 iterations and 15 nodes (0.24 seconds)
Optimality Based BT: 6 improved bounds
Optimality Based BT: 10 improved bounds
Couenne: new cutoff value -1.0518325320e+01 (0.323519 seconds)
Cbc0012I Integer solution of -10.518325 found by Couenne Rounding NLP after 293 iterations and 17 nodes (0.28 seconds)
Optimality Based BT: 11 improved bounds
Optimality Based BT: 9 improved bounds
Optimality Based BT: 10 improved bounds
Optimality Based BT: 5 improved bounds
Optimality Based BT: 6 improved bounds
Couenne: new cutoff value -1.0961821658e+01 (0.536504 seconds)
Cbc0012I Integer solution of -10.961822 found by Couenne Rounding NLP after 789 iterations and 59 nodes (0.50 seconds)
Cbc0010I After 100 nodes, 19 on tree, -10.961822 best solution, best possible -64.098307 (0.57 seconds)
Optimality Based BT: 6 improved bounds
Cbc0010I After 200 nodes, 7 on tree, -10.961822 best solution, best possible -10.987437 (0.74 seconds)
Cbc0001I Search completed - best objective -10.96182165769095, took 2031 iterations and 240 nodes (0.76 seconds)
Cbc0035I Maximum depth 23, 0 variables fixed on reduced cost
    "Finished"

Linearization cuts added at root node:         25
Linearization cuts added in total:             25  (separation time: 0.000157s)
Total solve time:                        0.761365s (0.761365s in branch-and-bound)
Lower bound:                             -10.9618
Upper bound:                             -10.9618  (gap: 0.00%)
Branch-and-bound nodes:                       240
Performance of                           FBBT:     0.009698s,      597 runs. fix:          0 shrnk:  0.0365667 ubd:          0 2ubd:          0 infeas:          2
Performance of                           OBBT:     0.053543s,       15 runs. fix:          0 shrnk:    1.52884 ubd:          0 2ubd:          0 infeas:          0
...
在可行域上画出等高线，标记目标解的位置， @fig-quadprog 展示无约束和有约束条件下的解。图中橘黄色线围成的三角形区域是可行域，红点表示无约束下求解器 `nloptr.slsqp` 获得的解 $(0,1)$ ，真正的无约束解是蓝点所在位置为 $(-4/3,1/3)$ ，黄点表示线性约束下求解器 `nloptr.slsqp` 获得的解 $(1/6,11/6)$ 。所以，不能用二次规划的求解器去求解无约束的二次规划问题。
...
**quadprog** 包在求解约束条件下的严格凸二次规划问题时，同时给出无约束条件下的解。这个包自定义了一套二次规划问题的符号，查看求解函数 `solve.QP()` 的说明，略作对应后，求解上述规划问题的代码如下。
