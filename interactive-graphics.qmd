...
如果读者想进一步了解 **htmlwidgets** 框架，JavaScript 响应式编程，推荐 John Coene 新书 [JavaScript for R](https://book.javascript-for-r.com/)
