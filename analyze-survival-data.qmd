...
R 软件内置了 [**survival**包](https://github.com/therneau/survival) 它是实现生存分析的核心 R 包 [@Terry2000]
...
-   逻辑回归，响应变量是无序的分类变量，假定服从二项、多项分布
-   Probit 回归，响应变量是有序的分类变量，
-   Tobit 回归，响应变量
