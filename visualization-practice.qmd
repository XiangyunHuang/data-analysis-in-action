...
[**SpatialKDE**](https://github.com/JanCaha/SpatialKDE)
...
[vcd](https://cran.r-project.org/package=vcd) [@Meyer2006;@Zeileis2007]
Visualizing Categorical Data [@Friendly2016]
...
**vcd** 包针对分类数据做了很多专门的可视化工作，内置了很多数据集和绘图函数，在 Base R 绘图基础上，整合了许多统计分析功能，提供了一个统一的可视化框架[@Meyer2006;@Zeileis2007]，更多细节见著作《Discrete Data Analysis with R》[@Friendly2016]。
