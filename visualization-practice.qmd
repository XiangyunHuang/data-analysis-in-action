...
## 解释二项分布参数的置信带 {#sec-confidence-belt}

<!-- 
0 和 1 是世界的原点，蕴含大道真意。本书多个地方涉及二项分布，从二项分布衍生出来超几何分布、泊松分布、正态分布、贝塔分布等等 
-->

解释二项分布参数的置信带，内容来自 C. J. Clopper 和 E. S. Pearson 的经典论文《The Use of Confidence or Fiducial Limits Illustrated In The Case of The Binomial》[@Clopper1934]。
