...
Steven L. Scott 提出贝叶斯结构时间序列模型，用于推断因果效应[@Scott2015]，该分析方法被谷歌 GA 套件中的预测模块采用。之后开发了 [**Boom**](https://github.com/steve-the-bayesian/BOOM) 框架，基于该框架的 [**bsts**](https://github.com/steve-the-bayesian/BOOM/tree/master/Interfaces/R) 包提供贝叶斯可加时间序列模型拟合和预测的功能。

### 脸书的 Prophet 框架 {#sec-facebook-prophet}

[**prophet**](https://github.com/facebook/prophet) 基于贝叶斯可加模型的时间序列预测。深入模型，理解 Stan 代码，并且能够改造模型和代码。
