...
2.  [BNOSAC](https://github.com/bnosac) 提供一系列计算机视觉、图像识别、自然语言处理方面的 R 包，比如 [word2vec](https://github.com/bnosac/word2vec) 包、[doc2vec](https://github.com/bnosac/doc2vec) 包等。
