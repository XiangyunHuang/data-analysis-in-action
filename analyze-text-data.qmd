...
首先将所有日志分词、向量化，构建 DTM 矩阵。

<https://text2vec.org/topic_modeling.html#latent_semantic_analysis>

创建文档-词矩阵 document-term matrix (DTM)
...
#### LSA 算法 {#sec-latent-semantic-analysis}

```{r}
```

#### LDA 算法 {#sec-latent-dirichlet-allocation}
...
词共现矩阵 tcm （term co-occurrence matrix）GloVe Word Embeddings <https://text2vec.org/glove.html>
