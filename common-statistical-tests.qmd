...
## 单样本检验 {#common-statistical-tests-sec-one-sample}
...
## 两样本检验 {#common-statistical-tests-sec-two-samples}
...
## 多样本检验 {#common-statistical-tests-sec-multi-samples}
...
## 配对样本检验 {#common-statistical-tests-sec-pairwise-data}

配对样本检验算是两样本检验的一种特殊情况。若待检验的样本不止两个，则两两配对检验。

### 配对 t 检验 {#common-statistical-tests-sec-pairwise-t-test}
...
### 逐对比例检验 {#common-statistical-tests-sec-pairwise-prop-test}
...
### 配对 Wilcoxon 检验 {#common-statistical-tests-sec-pairwise-wilcox-test}
...
### 配对相关性检验 {#common-statistical-tests-sec-cor-test}
...
### 同分布检验 {#common-statistical-tests-sec-ks-test}
...
### 独立性检验 {#common-statistical-tests-sec-Box-test}

时间序列独立性检验 `Box.test()` 计算 Box-Pierce 或 Ljung-Box 检验统计量来检查给定时间序列的独立性假设。

### 平稳性检验 {#common-statistical-tests-sec-PP-test}
...
### 球形检验 {#common-statistical-tests-sec-mauchly-test}
...
## 假设检验的一些注记 {#common-statistical-tests-sec-common-statistical-tests-notes}
...
| 姓名                                                               | 国籍           | 出生       | 死亡       | 寿命  | 贡献                      |
|-----------|-----------|----------|---------|------|---------------|
| [Karl Pearson](https://en.wikipedia.org/wiki/Karl_Pearson)         | 英国           | 1857-03-27 | 1936-04-27 | 79    | 卡方分布、卡方检验        |
...
| [Frank Wilcoxon](https://en.wikipedia.org/wiki/Frank_Wilcoxon)     | 美国           | 1892-09-02 | 1965-11-18 | 73    | Wilcoxon 符号秩、秩和检验 |
| [Jerzy Neyman](https://en.wikipedia.org/wiki/Jerzy_Neyman)         | 波兰、美国     | 1894-04-16 | 1981-08-05 | 87    | Neyman-Pearson 引理       |
| [Egon Pearson](https://en.wikipedia.org/wiki/Egon_Pearson)         | 英国           | 1895-08-11 | 1980-06-12 | 84    | Neyman-Pearson 引理       |
| [B. L. Welch](https://en.wikipedia.org/wiki/Bernard_Lewis_Welch)   | 英国           | 1911       | 1989-12-29 | 77-78 | Welch t 检验              |
| [E. L. Lehmann](https://en.wikipedia.org/wiki/Erich_Leo_Lehmann)   | 法国、美国     | 1917-11-20 | 2009-09-12 | 91    | Lehmann--Scheffé 定理     |
| [Abraham Wald](https://en.wikipedia.org/wiki/Abraham_Wald)         | 匈牙利         | 1902-10-31 | 1950-12-13 | 48    | Wald 检验                 |
| [Frank Yates](https://en.wikipedia.org/wiki/Frank_Yates)           | 英国           | 1902-05-12 | 1994-06-17 | 92    | Yates 矫正                |
...
: 对假设检验理论有重要贡献的学者 {#tbl-statistical-hypothesis}

其中，最重要的统计学家及其传承关系见下 @fig-testing-statistical-hypothesis 。
...
### 假设检验和多重比较的关系 {#common-statistical-tests-sec-multiple-comparison}
...
### 假设检验的工业应用 {#common-statistical-tests-sec-industrial-application}
...
## 习题 {#common-statistical-tests-sec-common-statistical-tests-exercise}
